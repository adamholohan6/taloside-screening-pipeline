"""
Test script to run Phase 3 ligand preparation on a single failing compound
with diagnostic logging to identify the exact failure point.
"""
...
# Test the SMILES directly from Phase 2 output
df = pd.read_csv("phase2_output/07_lead_scored.csv")
single_compound = df.iloc[[0]]  # First compound
compound_id = single_compound.iloc[0]['compound_id']
smiles = single_compound.iloc[0]['product_smiles']

print("=" * 70)
print("TESTING SINGLE COMPOUND - DIRECT RDKIT PARSING")
print("=" * 70)
